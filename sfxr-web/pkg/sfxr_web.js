...
export class SoundEffectGenerator {
    ...
    */
    play() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.soundeffectgenerator_play(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            if (r1) {
                throw takeObject(r0);
    ...
    */
    preset(name, seed) {
        try {
            ...
            wasm.soundeffectgenerator_preset(retptr, this.__wbg_ptr, ptr0, len0, seed);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            if (r1) {
                throw takeObject(r0);
    ...
    */
    export_raw() {
        const ret = wasm.soundeffectgenerator_export_raw(this.__wbg_ptr);
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_start_12c9eb4c354ec340 = function() { return handleError(function (arg0) {
    ...
    imports.wbg.__wbg_disconnect_13e3b9054333eb88 = function() { return handleError(function (arg0) {
