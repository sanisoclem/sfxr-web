...
export class SoundEffectGenerator {
    ...
    */
    preset(name, seed) {
        try {
            ...
            wasm.soundeffectgenerator_preset(retptr, this.ptr, ptr0, len0, low1, high1);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            if (r1) {
                throw takeObject(r0);
    ...
    */
    export_raw() {
        var ret = wasm.soundeffectgenerator_export_raw(this.ptr);
    ...
    */
    export_wav() {
        var ret = wasm.soundeffectgenerator_export_wav(this.ptr);
        return takeObject(ret);
    }
}
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('sfxr_web_bg.wasm', import.meta.url);
    }
    const imports = {};
    imports.wbg = {};
    ...
    imports.wbg.__wbg_sampleRate_bbd2ffd5bd9d2052 = function(arg0) {
