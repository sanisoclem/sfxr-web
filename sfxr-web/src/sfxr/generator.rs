...
impl Oscillator {
    ...
    pub fn reset(
        ...
        self.fperiod = 100.0 / (base_freq.powi(2) + 0.001); // if base_freq is 0, fperiod = 100K or 0.441 Hz, if base_freq is 1, period = 100 or 441 Hz
        self.fmaxperiod = 100.0 / (freq_limit.powi(2) + 0.001); // sets the lowest frequency possible
    ...
    pub fn advance(&mut self) {
        ...
        self.fperiod = (self.fperiod * self.fslide).min(self.fmaxperiod); // sets min period or max freq
